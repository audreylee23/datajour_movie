...
# 3번: 시놉시스 키워드
st.markdown('***')
st.subheader("3. 워드클라우드로 시놉시스에서 유행한 키워드를 알아보자.")
...
#4번
st.markdown('***')
st.subheader("4. 연도별 시놉시스 키워드의 트렌드를 알아보자.")
...
#5번
st.markdown('***')
st.subheader("5. 연도별 장르의 트렌드를 알아보자.")
...
#6번
st.markdown('***')
st.subheader("6. 주요 장르별 시놉시스 키워드의 특이한 변화 추이를 알아보자.")
...
st.subheader('키워드로 영화 시놉시스 검색하기')
