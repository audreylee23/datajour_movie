...
st.write("가령 '사랑'의 비율은 1980년대에는 2% 정도였지만, 2020년대에는 0.5% 미만으로 떨어지는 모습을 살펴볼 수 있다. 또 '사건'이라는 키워드는 전반적으로 증가하는 추세를 보이며, 반대로 '아버지'나 '결혼' 등의 키워드는 지속적으로 감소하고 있다. 한편 '친구'와 같은 키워드들은 시대를 막론하고 꾸준한 빈도로 등장하고 있다.")
...
st.write("우선, 시대를 막론하고 '드라마'와 '액션' 장르가 꾸준히 높은 비중을 차지하고 있다. 반면 '코미디'의 경우 2000년대 후반에 급증했다가 다시 감소하는 들쭉날쭉한 모습을 보인다.")
